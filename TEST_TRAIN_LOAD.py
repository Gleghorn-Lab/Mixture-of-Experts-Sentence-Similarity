...
def parse_args():
    ...
    parser.add_argument("--save_path", type=str, default="lhallee/TRAIN_LOAD_SE", help="Base path to save the model and report to wandb")
    ...
    parser.add_argument("--save_every", type=int, default=2000, help="Save the model every n steps and evaluate every n steps")
...
def main(args):
    ...
    run_name = f"se_TEST_LOAD_run_{domain}"
