...
from models.outputs import MoEsmOutputWithPastAndCrossAttentions, MoEsmOutputWithPoolingAndCrossAttentions
from models.losses import LoadBalancingLoss
...
class MoEsmEncoder(nn.Module):
    ...
    def forward(
        ...
        return MoEsmOutputWithPastAndCrossAttentions(
...
ESM_START_DOCSTRING = r"""
    ...
    Parameters:
        config ([`MoEsmConfig`]): Model configuration class with all the parameters of the
...
@add_start_docstrings(
    "The bare MOESM Model transformer outputting raw hidden-states without any specific head on top.",
    ESM_START_DOCSTRING,
)
class MoEsmModel(MoEsmPreTrainedModel):
    ...
    @add_code_sample_docstrings(
        ...
        output_type=MoEsmOutputWithPoolingAndCrossAttentions,
    ...
    def forward(
        ...
        return MoEsmOutputWithPoolingAndCrossAttentions(
...
@add_start_docstrings("""MOESM Model with a `language modeling` head on top.""", ESM_START_DOCSTRING)
...
@add_start_docstrings(
    """
    MOESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
@add_start_docstrings(
    """
    MOESM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
